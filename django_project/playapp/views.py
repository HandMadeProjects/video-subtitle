...
media_full_path = settings.STATIC_MEDIA_ROOT + "\\static\\playapp\\uploaded_files"
...
def index(request):
    ...
    return render(request, 'playapp/index.html', {'playvideo': playVideoDetails, 'allvideos': videos})
    # return render(request, 'playapp/index.html')  # Create an HTML file for your upload form
...
def upload_files(request):
    ...
    return render(request, 'playapp/upload_video.html')  # Create an HTML file for your upload form
